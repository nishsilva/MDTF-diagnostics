...
model_mean_zos_rg = regrid_to_gr(model_mean_zos, model_mean_zos.zos, delta_lat, delta_lon, w, e, s, n, 'bilinear')
...
fig = plt.figure(figsize=(12, 16), tight_layout=True)
ax = fig.add_subplot(3, 1, 1, projection=ccrs.Robinson())
error.__xarray_dataarray_variable__.plot(ax=ax) 
...
plot_and_save_figure("model", title_string, mdt_rg)
